...
class MacroProcessor {
	...
	static void pass1() throws Exception {
		String s = new String();
		input = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\Lonkar\\Documents\\NetBeansProjects\\sposassignment\\macrotbl/input.txt")));
		PrintWriter output = new PrintWriter(new FileOutputStream("C:\\Users\\Lonkar\\Documents\\NetBeansProjects\\sposassignment\\macrotbl/output_pass1.txt"), true);
	...
	static void showAla(int pass) throws Exception {
		PrintWriter out = new PrintWriter(new FileOutputStream("C:\\Users\\Lonkar\\Documents\\NetBeansProjects\\sposassignment\\macrotbl/out_ala_pass" + pass + ".txt"), true);
		for(List l : ala) {
	...
	static void showMnt() throws Exception {
		PrintWriter out = new PrintWriter(new FileOutputStream("C:\\Users\\Lonkar\\Documents\\NetBeansProjects\\sposassignment\\macrotbl/out_mnt.txt"), true);
		for(MntTuple l : mnt) {
			System.out.println(l);
			out.println(l);
		}
	...
	static void showMdt() throws Exception {
		PrintWriter out = new PrintWriter(new FileOutputStream("C:\\Users\\Lonkar\\Documents\\NetBeansProjects\\sposassignment\\macrotbl/out_mdt.txt"), true);
		for(String l : mdt) {
			System.out.println(l);
			out.println(l);
		}
