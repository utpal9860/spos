...
import java.util.*;
import java.io.*;
import static sposassignment.MacroProcessor.ala;
...
class passtwoofthemacro {
	...
	static void pass2() throws Exception {
		input = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\Lonkar\\Documents\\NetBeansProjects\\sposassignment\\macrotbl/output_pass1.txt")));
		PrintWriter output = new PrintWriter(new FileOutputStream("C:\\Users\\Lonkar\\Documents\\NetBeansProjects\\sposassignment\\macrotbl/output_pass2.txt"), true);
