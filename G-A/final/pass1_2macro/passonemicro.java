...
class passonemicro {
	...
	static void pass1() throws Exception {
		String s = new String();
		input = new BufferedReader(new InputStreamReader(new FileInputStream("Macrotbl/input.txt")));
		PrintWriter output = new PrintWriter(new FileOutputStream("Macrotbl/output_pass1.txt"), true);
	...
	static void showMnt() throws Exception {
		PrintWriter out = new PrintWriter(new FileOutputStream("Macrotbl/out_mnt.txt"), true);
		for(MntTuple l : mnt) {
			System.out.println(l);
			out.println(l);
		}
	...
	static void showMdt() throws Exception {
		PrintWriter out = new PrintWriter(new FileOutputStream("Macrotbl/out_mdt.txt"), true);
		for(String l : mdt) {
			System.out.println(l);
			out.println(l);
		}
